...
// ============================================================================
export async function getGameWithAllStats(gameId) {
...
// ============================================================================
export async function getTopScorersInGame(gameId, limit = 10) {
    return await db
        .select()
        .from(boxScores)
...
// ============================================================================
export async function getTeamSeasonRecord(teamId, season) {
...
//# sourceMappingURL=example-queries.js.map